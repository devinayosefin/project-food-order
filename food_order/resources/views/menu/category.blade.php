            ...
            <div class="p-6">
                ...
                <div class="mt-4 flex items-center justify-between">
                    @if($menu->stock > 0)
                        ...
                        @else
                            <button type="button" class="w-full bg-gray-400 text-white font-bold py-2 px-4 rounded-full cursor-not-allowed" onclick="alert('Harus login dulu untuk menambahkan ke keranjang!')">
                                + Tambahkan ke Keranjang
                            </button>
                        @endif
                    @else
